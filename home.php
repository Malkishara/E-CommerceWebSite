<?php
/*
This php code will get the item data from POST method when click on the Add to Cart button.
All the data store in the cartarray. 
            ...
            <ul class="navbar-nav">
                ...
                <a class="nav-link dropdown-toggle " href="#" data-toggle="dropdown" >
                    <svg xmlns="http://www.w3.org/2000/svg" width="50" height="50" fill="currentColor"
                        ...
                        <!--Get the User NAME HERE BY SESSION WHICH WAS SENT BY LOGIN PAGE-->
...
<nav class="navbar navbar-expand-sm bg-dark">
        <ul class="nav nav-pills">
            <li class="nav-item active">
                <a class="nav-link text-white bg-warning" href="home.php"><h5>Home</h5></a>
            </li>
            <li class="nav-item">
    ...
    <div id="demo" class="carousel slide" data-ride="carousel">
        ...
        <div class="carousel-inner">
            <div class="carousel-item active">
                <img src="img/s1.jpg" alt="" width="1200" height="500">
            </div>
            <div class="carousel-item">
                <img src="img/s2.jpg" alt="" width="1200" height="500">
            </div>
            <div class="carousel-item">
                <img src="img/s3.jpg" alt="" width="1200" height="500">
            </div>
            <div class="carousel-item">
                <img src="img/s4.jpg" alt="" width="1200" height="500">
            </div>
            <div class="carousel-item">
                <img src="img/s5.jpg" alt="" width="1200" height="500">
            </div>
        </div>
...
<div class="container pt-4">
    ...
    <h2 class="bg-success text-center">Featured Posts</h2>

</div>

<!--Cards started from here-->
<br>
    ...
    <div class="row" >
        ...
        ?>
            <tr >
                ...
                <?php
                $result = mysqli_query($con, "SELECT * FROM `items` WHERE rate=4 LIMIT ".($rowcount*4)." , ".(($rowcount*4)+4)." ");
                    $rcount=0;
                                    ...
                                    <div class="product-item">
                                        <div class="pi-img-wrapper">
                                            ...
                                            <div class="text-center">
                                                <img src="img/<?php echo "".$row['code'].""; ?>.jpg" class="img-responsive" alt="Berry Lace Dress"
                                        ...
                                        <h5><a href="view.php?pcode=<?php echo $row['code'];?>"><?php echo "  " . $row['name'] . ""; ?></a></h5>
                                        ...
                                        <div class="card-footer" style="font-size:23px;">
                                        
                                            <form method='post' action=''>
                                                    <?php echo "Rs." . $row['price'] . ""; ?>&nbsp;
                                                    <input type='hidden' name='code' value="<?php echo $row['code'] ; ?>"/>

                                                    <button type='submit'  class='btn btn-warning' style='width:150px; height:40px;'>
                                                    <strong>
...
<div class="container-fluid" style="position: fixed-bottom;">
    <br>
    <br>
    <nav class="navbar navbar-expand-lg bg-dark bottom" style="height: 300px;">
        <div class="container">
