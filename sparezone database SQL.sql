...
--
-- Host: 127.0.0.1:3306
-- Generation Time: Sep 29, 2021 at 06:40 PM
...
(5, 'OE Type Car Front Bumper', 5000, 'There are a number of reasons you may be in the market to buy car bumpers online. Car bumpers can get dented or damaged due to another vehicle hitting your car, or when you or another driver run into something.', 49, 'P103', 4),
...
INSERT INTO `temporary` (`code`, `price`, `quantity`, `total`, `user_id`) VALUES
('P103', 5000, 1, 5000, 5),
('P108', 1000, 1, 1000, 5);
COMMIT;
